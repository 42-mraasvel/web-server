...
class ChunkedParser
{
	...
	*/
		...
		int appendMessageBody(std::string& dest);
		int appendHeader(HeaderField& dest);
	...
	private:
		...
		int parseSize(std::string const & buffer, std::size_t & index);
		int parseData(std::string const & buffer, std::size_t & index);
		int parseTrailer(std::string const & buffer, std::size_t & index);
		int parseEndLine(std::string const & buffer, std::size_t & index);
		int parseDiscardLine(std::string const & buffer, std::size_t & index);
